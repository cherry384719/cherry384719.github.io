...
math: Optional(default is false)
media_subpath: /path/to/media/
pin: true  # pin one or more posts to the top of the home page
toc: Optional(default is true)   # the Table of Contents
comments: Optional(default is true)
...
对于基本的md语法来说，图片显示方法为：`![descriptiom](path/to/photo)`。此外，在本主题中还能对图片大小、位置、名称、阴影进行调整。
